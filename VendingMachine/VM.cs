...
namespace VendingMachine
{
    internal class VM : IVending
    {
        ...
        public int[] aDeposit = new int[99];
        public string[] aPurchasedItems = new string[99];
        ...
        public void EndTransaction()
        {
            ...
            if (Saldo >= 1)
            {
                ...
                Console.WriteLine();
                Console.WriteLine("The Machine keeps the remaining balance of " + Saldo + ". In Switzerland they called it Adjo fee!");
                Saldo -= (nrOfCoins * 1);
            }
        ...
        public void ShowAll()
        {
            ...
            foreach (Product product in myProductList)
            {
                ...
                int nrOfSpaces = 25 - product.ProductName.Length;
                for (int i = 0; i < nrOfSpaces; i++)
                {
                    Console.Write(" ");
                }
